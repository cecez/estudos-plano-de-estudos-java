...
- [x] Cria 3 pizzas com ingredientes diferentes
- [x] Adiciona essas Pizzas em um CarrinhoDeCompra
- [x] Imprime o total do CarrinhoDeCompra
- [x] Imprime a quantidade utilizada de cada ingrediente
